...
public class AwesomeExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<AwesomeException> handleInvalidProjectStatusException() {
    ...
    protected ResponseEntity<AwesomeException> handleEmployeeDeletedException() {
        return new ResponseEntity<>(new AwesomeException("Нельзя изменить удаленного сотрудника"), HttpStatus.BAD_GATEWAY);
    }
    ...
    protected ResponseEntity<AwesomeException> handleEmployeeIsNullException() {
        return new ResponseEntity<>(new AwesomeException("Сотрудник пустой"), HttpStatus.BAD_GATEWAY);
    }

    @ExceptionHandler(PasswordsNotMatchException.class)
    protected ResponseEntity<AwesomeException> handlePasswordsNotMatchException() {
        return new ResponseEntity<>(new AwesomeException("Пароли не совпадают"), HttpStatus.BAD_GATEWAY);
    }

    @ExceptionHandler(StatusUnaviablException.class)
    protected ResponseEntity<AwesomeException> handleStatusUnaviablException() {
        return new ResponseEntity<>(new AwesomeException("Статус недоступен"), HttpStatus.BAD_GATEWAY);
    }
    ...
    protected ResponseEntity<AwesomeException> handleProjectIsNullException() {
        return new ResponseEntity<>(new AwesomeException("Проект имеет значение null"), HttpStatus.BAD_GATEWAY);
    }
    ...
    protected ResponseEntity<AwesomeException> handleExecutorNotMemberOfTeamException() {
        return new ResponseEntity<>(new AwesomeException("Исполнитель не является участником команды"), HttpStatus.BAD_GATEWAY);
    }

    @ExceptionHandler(TaskIsNullException.class)
    protected ResponseEntity<AwesomeException> handleTaskIsNullException() {
        return new ResponseEntity<>(new AwesomeException("Задача имеет значание null"), HttpStatus.BAD_GATEWAY);
    }
